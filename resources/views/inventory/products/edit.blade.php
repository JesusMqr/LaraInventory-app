...
@section('header')
    ...
    @section('navigator')
    <a href="{{ route('categories.show',$product->id_category) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
@section('content')
    ...
    <form action="{{ route('products.update',$product->id) }}" method="POST" >
        ...
        @method('PUT')
        <div class="pb-5">
            <h2 class="font-semibold">Editar producto</h2>
        </div>
        ...
        <div class="relative z-0 w-full mb-5 group">
            ...
            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2
             border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 
             focus:outline-none focus:ring-0 focus:border-blue-600 peer" 
             placeholder=" " value="{{ $product->image_url }}" required />
        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2
                 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 
                 focus:outline-none focus:ring-0 focus:border-blue-600 peer" 
                 placeholder=" " required value="{{ $product->stock }}" />
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2
                 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 
                 focus:outline-none focus:ring-0 focus:border-blue-600 peer" 
                 placeholder=" " required value="{{ $product->min_stock }}" />
        ...
        <div class="hidden" >
            ...
            <input class="text-slate-800" type="number" name="id_category" value="{{ $product->id_category }}">
        </div>
        <div class="text-end">

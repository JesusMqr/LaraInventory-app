                    ...
                    <div class="container mx-auto">
                        ...
                        <form action="{{  route('products.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" class=" border text-gray-700  rounded w-full py-2 px-3"></textarea>
                            </div>
                            <div class="mb-4">
                                <label for="category" class="block text-gray-200">Categoría</label>
                                <input type="text" name="category" id="category" class=" border text-gray-700 rounded w-full py-2 px-3">
                            </div>
                            <div class="mb-4">
                                <label for="price" class="block text-gray-200">Precio</label>
                                <input type="number" step="0.01" name="price" id="price" class=" border text-gray-700 rounded w-full py-2 px-3" required>
                            </div>
                            <div class="mb-4">
                                <label for="stock" class="block text-gray-200">Stock</label>
                                <input type="number" name="stock" id="stock" class=" border text-gray-700 rounded w-full py-2 px-3"  required>
                            </div>
                            <div class="mb-4">
                                <label for="min_stock" class="block text-gray-200">Stock Mínimo</label>
                                <input type="number" name="min_stock" id="min_stock" class=" border text-gray-700 rounded w-full py-2 px-3"  required>
                            </div>
